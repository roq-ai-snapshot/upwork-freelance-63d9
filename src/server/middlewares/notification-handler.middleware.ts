...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'project_created.create': {
    roles: ['freelancer', 'agency-owner', 'agency-member'],
    key: 'project_id',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['freelancer'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['freelancer', 'client', 'agency-owner', 'agency-member', 'guest'];
