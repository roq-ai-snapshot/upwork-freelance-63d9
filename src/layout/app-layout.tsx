...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['freelancer', 'client', 'agency-owner', 'agency-member', 'guest'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Agencies', path: '/agencies', entity: 'agency', service: AccessServiceEnum.PROJECT, icon: FiUsers },
    {
      name: 'Agency Members',
      path: '/agency-members',
    ...
    { name: 'Bids', path: '/bids', entity: 'bid', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Projects', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
